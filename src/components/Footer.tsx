          ...
          <section aria-labelledby="contact-heading">
            ...
            <address className="not-italic text-white/70 space-y-3">
              <div className="flex items-center space-x-3 min-h-[44px]">
                <svg className="w-5 h-5 text-navy-primary" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a
                  ...
                  className="text-white/70 hover:text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-navy-primary focus:ring-offset-2 focus:ring-offset-navy-primary rounded-sm"
              ...
              <div className="flex items-center space-x-3 min-h-[44px]">
                <svg className="w-5 h-5 text-navy-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              ...
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-navy-primary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
