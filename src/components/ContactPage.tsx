          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-large p-8">
                ...
                <div className="space-y-6">
                  {content.contactInfo.methods.map((method, index) => (
                    ...
                    >
                      <div className="flex-shrink-0 w-12 h-12 bg-navy-primary rounded-lg flex items-center justify-center text-white group-hover:bg-navy-primary transition-colors duration-200">
                        {method.icon}
                      </div>
                      <div className="flex-1">
                        <h3 className="font-semibold text-navy-primary group-hover:text-navy-primary transition-colors duration-200">
                          {method.label}
                        </h3>
              ...
              <div className="bg-white rounded-lg shadow-large p-8">
                ...
                {/* Current Time */}
                <div className="bg-navy-primary/10 rounded-lg p-4 mb-6">
                  <div className="flex items-center justify-between">
                    <span className="text-navy-primary font-semibold">
                      {content.businessHours.currentTime}:
                    </span>
                    <span className="text-navy-primary font-bold text-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            <a
              ...
              className="inline-flex items-center px-6 py-3 bg-navy-primary text-white font-semibold rounded-lg hover:bg-navy-primary/90 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-navy-primary focus:ring-offset-2"
            >
